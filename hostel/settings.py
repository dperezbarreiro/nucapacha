...
INSTALLED_APPS = [
    ...
    'hostel.popups.apps.PopupsConfig',
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'hostel', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_ROOT = os.path.join(BASE_DIR, 'hostel', 'about_us', 'static')
STATIC_URL = '/static/'
...
ADMIN_REORDER = (
    {'app': 'about_us', 'label': 'Sitio - Gestion de contenido', 'models': (
        ...
        {'model': 'popups.Popup', 'label': 'Popups'},
    )},
